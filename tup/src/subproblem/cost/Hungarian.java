...
public class Hungarian implements Match {
    ...
    public int[][] getOptimalMatch(int[][] costMatrix) {
        return hgAlgorithm(costMatrix, "min");
    }

    public static int findLargest //Finds the largest element in a positive array.
    (int[][] array) //works for arrays where all values are >= 0.
    {
        int largest = 0;
    ...
    //**********************************//
    public int[][] hgAlgorithm(int[][] array, String sumType) {
        int[][] cost = copyOf(array);    //Create the cost matrix
    ...
    public static int hg_step1(int[][] cost) {
        //What STEP 1 does:
    ...
    public static int hg_step2(int[][] cost, int[][] mask, int[] rowCover, int[] colCover) {
        //What STEP 2 does:
    ...
    public static int hg_step6(int[][] cost, int[] rowCover, int[] colCover, int maxCost) {
        //What STEP 6 does:
